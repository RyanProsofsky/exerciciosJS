...
let salarioFixo = prompt('Digite o sálario: R$');
let percentualReajuste = prompt('Digite o percentual de reajuste: ');
let contaPercentual = (percentualReajuste * salarioFixo) / 100
let salarioFinal =  parseFloat(contaPercentual) + parseFloat(salarioFixo);

console.log(`O salario com reajuste é de: R$${salarioFinal}`);
*/
...
//9. Desenhe um algoritmo para determinar o consumo medio de um automovel, considerando que a distancia total percorrida e o total de combustivel gasto sao fornecidos.
/*
let combustivelGasto = prompt('Digite quantos litros de combustivel foi abastecido:  ')
let distanciaTotal = prompt('Digite a distancia percorrida: ')
let consumoMedio =parseFloat(distanciaTotal) / parseFloat(combustivelGasto) 

//let combustivelGasto = '20.45265296519415161988789'
//let distanciaTotal = '30.546'
// console.log(parseFloat(combustivelGasto).toFixed(6))


console.log(`O consumo médio é de: ${consumoMedio.toFixed(2)}km `)
*/
...
/*
let nomeVendedor = prompt('Escreva o nome do vendedor: ');
let salarioFixo = prompt('Digite o salário R$: ');
let totalVendas = prompt('Digite o total de vendas R$: ');
let porcentagem = (totalVendas * 15) / 100
let salarioFinal = parseFloat(porcentagem) + parseFloat(salarioFixo)
...
/*
let aplicacao = prompt('Escreva o valor da aplicação R$:')
let rentabilidade =  (aplicacao * 0.50) / 100 

console.log(`A rentabilidade foi de:${rentabilidade}`)
